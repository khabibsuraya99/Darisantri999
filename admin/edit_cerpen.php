<?php
    ...
    $q = "SELECT * FROM ms_cerpen WHERE id='".$_GET['id']."'";
...
<body>
    <div class='container-sm mt-5' width='400px'>
        <div class="mb-3">
        <form action='update_cerpen.php' method='POST'>
            <input type='hidden' name='ipId' value='<?php echo $id ?>' >
            <h2 class="text-start text-success">Edit Cerpen</h2><hr>
            ...
            <h6 class="text-start text-success">Judul Cerpen</h6>
