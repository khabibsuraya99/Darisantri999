<?php
    ...
    $q = "SELECT * FROM ms_reviewngaji WHERE id='".$_GET['id']."'";
...
<body>
    <div class='container-sm mt-5' width='400px'>
        ...
        <form action='update_review.php' method='POST'>
            ...
            <h2 class="text-start text-success">Edit Review Ngaji</h2><hr>
            ...
            <h6 class="text-start text-success">Judul Review Ngaji</h6>
            <input type='text' class="form-control" name='ipJudul' required value='<?php echo $jdl ?>'> <br>
            <h6 class="text-start text-success">Isi Review Ngaji</h6>
